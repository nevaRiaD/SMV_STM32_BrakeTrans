...
This driver reads a **brake pressure transducer** using the STM32’s ADC, converts it to PSI, and sends through CAN bus using the "SMV_STM32_CANbus" library https://github.com/UCLA-Bruin-Supermileage/SMV_STM32_CANbus.  
